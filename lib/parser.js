...
//returns -1 if error
exports.score = function (seismicPortalJsonObj, articles_2d) {
    let scoreArr = Array.from({ length: (seismicPortalJsonObj.features).length }, () => -1);
    let obj = seismicPortalJsonObj;
